      ...
      <>
        <header className="furatto-header fixed top-0 left-0 right-0 z-50">
          <div className="furatto-header-inner">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  {instagramUsername && (
                    <a
                      ...
                      className="w-8 h-8 flex items-center justify-center rounded-full bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 hover:opacity-80 transition-opacity"
            ...
            {/* ===== PC ===== */}
            <div className="hidden lg:block relative px-8 py-2">
              {/* 左: ロゴ（absolute） */}
              ...
              {/* 右: IG + 言語 + 公式サイトボタン（absolute） */}
              <div className="absolute right-8 top-1/2 -translate-y-1/2 z-10 flex flex-col items-end gap-1.5">
                <div className="flex items-center gap-2">
                  {instagramUsername && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="furatto-header-ig-btn w-7 h-7 flex items-center justify-center rounded-full bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 hover:opacity-80 transition-opacity"
                      aria-label="Instagram"
                    >

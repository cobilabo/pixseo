              ...
              <div className="flex items-center justify-between px-3 h-11">
                ...
                {instagramUsername ? (
                  <a
                    ...
                    className="w-8 h-8 flex items-center justify-center rounded-full bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 text-white hover:opacity-80 transition-opacity flex-shrink-0"

            ...
            <form id="category-edit-form" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-32 px-3 py-2 text-gray-900 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  min={0}
                />
              </div>
            </div>
